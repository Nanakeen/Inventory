                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control"  name="mobile_no" placeholder="eg. 233245002022">
                                        @error('mobile_no')
                                        <span class="btn btn-danger">{{$message}}</span> 
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="form-control" name="rank_id">
                                        ...
                                        <option value="{{ $ran->id }}">{{ $ran->name }}</option>
                                       @endforeach
                                    </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="othernames" placeholder="Other Name(s)">
                                        @error('othernames')
                                        <span class="btn btn-danger">{{$message}}</span> 
                                        @enderror
                                    </div>
