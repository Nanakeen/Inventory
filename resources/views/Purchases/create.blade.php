            ...
            <div class="card-body">
                <form action="{{route('storepro')}}" method="POST" id="myForm" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select id="supplier_id" name="supplier_id" class="form-control form-select select2" aria-label="Default select example">
                 ...
                 <div class="card-bord">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('purstore')}}">
                            @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(document).on("click",".addeventmore", function(){
                ...
                var return_or_non = $('#product_id').find('option:selected').text();
