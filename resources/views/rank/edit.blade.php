    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <h5>Bio Data</h5>
                <hr>
                <form action="{{route('rankupdate')}}" method="POST" id="myForm" >
                    @csrf
                    
            <input type="hidden" name="id" value="{{ $ran->id }}">
                    <div class="row">
                        <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label">Rank Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name" value="{{$ran->name}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="supplier_id"   value="" class="form-control">
                                        ...
                                        <option value="{{$sup->id }}"{{$sup->id==$ran->supplier_id ? 'selected': ''}}>{{ $sup->name }}</option>
                                       @endforeach
                                        </select>
                                </div>
                            </div>
